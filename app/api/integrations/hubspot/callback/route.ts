...
export async function GET(request: NextRequest) {
  try {
    ...
    const tokenData = await HubSpotIntegration.exchangeCode(code);
    console.log('[HUBSPOT-OAUTH] Token data received:', { 
    ...
    console.log('[HUBSPOT-OAUTH] Credentials to encrypt:', {
    ...
    console.log('[HUBSPOT-OAUTH] Encrypted credentials length:', encryptedCredentials?.length || 0);
    ...
    console.log('[HUBSPOT-OAUTH] Database insert result:', { success: !dbError, hasData: !!data });
