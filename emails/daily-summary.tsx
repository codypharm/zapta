 ...
 * Sent daily with activity summary
 */
...
export const DailySummaryEmail = ({
  ...
  const previewText = `Your daily summary for ${date}`;
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Hi {userName}, here's your activity summary for {date}:
          </Text>
          ...
          {activity.agentActivity.length > 0 && (
            <>
              <Text style={sectionTitle}>Agent Activity</Text>
          ...
          {activity.conversations === 0 && activity.leads === 0 && (
            <Section style={emptyState}>
              <Text style={emptyText}>
                No activity yesterday. Your agents are ready when you need them!
              </Text>
            </Section>
          )}
          ...
          <Text style={footer}>
            You're receiving this daily summary because it's enabled in your settings.{" "}
